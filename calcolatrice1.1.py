...
cancella = tkinter.Button(f, text="<--", bg="#142e47", fg="#3c97e8", bd=1, width=10, height=5, command=indietro)
...
diviso = tkinter.Button(f, text="÷", bg="#142e47", fg="#3c97e8", bd=1, width=10, height=5, command=lambda: pressione("/"))
uguale = tkinter.Button(f, text="=", bg="#142e47", fg="#3c97e8", activeforeground="#374d62", bd=1, width=10, height=11, command=risul)
